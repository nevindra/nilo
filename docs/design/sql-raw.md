...
| [205](../adr/205-a-raw-statement-can-carry-its-total.md) | `rawPage` and `rawPageOrdered`, a raw statement that answers a `Page(Row)`, with its total past the last row |
