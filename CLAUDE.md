...
- **`docs/adr/`** — 152 binding decisions, each naming the alternative it
...
and the six `refusals` steps check the wording of 183 error messages. Prefer making
...
zig build refusals     # the framework's 109 compile-error checks — NOT the others
