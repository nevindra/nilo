...
- **`docs/adr/`** — 108 binding decisions, each naming the alternative it
...
and the five `refusals` steps check the wording of 151 error messages. Prefer making
...
zig build refusals     # the framework's 85 compile-error checks — NOT the others
